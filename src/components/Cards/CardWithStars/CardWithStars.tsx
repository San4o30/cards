...
import styles from "./CardWithStars.module.css";
import { user, home, mapPin, star } from "../../../assets/index";

interface CardWithStarsProps {
  hotel: IPhotos;
}
const CardWithStars: FC<CardWithStarsProps> = ({ hotel }) => {
  return (
    <div className={styles.card_with_stars}>
      ...
      <div className={styles.card_content}>
        ...
        <div className={styles.card_content_info}>
          ...
          <p className={styles.card_content_info_text}>{hotel.info}</p>
